...
Обращайся к человеку по имени 1-2 раза за весь ответ - там, где это звучит органично, не в каждой карточке.
Используй только существующие слова русского языка. Никаких неологизмов и несуществующих форм - вместо "Осторожайся" пиши "Имей в виду" или "Помни", вместо выдуманных слов - нейтральные литературные аналоги.
...
{
  "name": "${name}",
  "sun": { "sign": "знак", "title": "Солнце в [Знак]", "subtitle": "Ядро твоей личности", "text": "2-3 предложения про суть личности" },
  "moon": { "sign": "знак", "title": "Луна в [Знак]", "subtitle": "Твой эмоциональный мир", "text": "2-3 предложения про эмоциональные паттерны" },
  "rising": { "sign": "знак", "title": "Асцендент в [Знак]", "subtitle": "Как тебя видят", "text": "2-3 предложения про первое впечатление" },
  "mercury": { "sign": "знак", "title": "Меркурий в [Знак]", "subtitle": "Как ты думаешь и говоришь", "text": "2-3 предложения про стиль мышления и коммуникации" },
  "mars": { "sign": "знак", "title": "Марс в [Знак]", "subtitle": "Твоя энергия и действие", "text": "2-3 предложения про мотивацию и желания" },
  "jupiter": { "sign": "знак", "title": "Юпитер в [Знак]", "subtitle": "Где тебе везёт", "text": "2-3 предложения про зону роста и удачи" },
  "saturn": { "sign": "знак", "title": "Сатурн в [Знак]", "subtitle": "Твои уроки и дисциплина", "text": "2-3 предложения про жизненные уроки" },
  "energy": { "title": "Энергия сейчас", "subtitle": "${dateLabel}", "text": "2-3 предложения про актуальные транзиты" },
  "glossary": "1-2 предложения для тех, кто не знает астрологию: простыми словами, без терминов, что означают ключевые знаки в этой карте"
}`;
