    ...
    <section className="w-full max-w-3xl mx-auto px-6 py-20 md:py-28">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {[
          ...
          {
            name: "Кристина",
            text: "Визуально всё приятно и современно, интерфейс интуитивный, карта формируется быстро. Многие описания откликнулись - в некоторых моментах буквально узнала себя. Отличное сочетание эстетики и персонального подхода!",
          },
          {
            name: "Ирина",
